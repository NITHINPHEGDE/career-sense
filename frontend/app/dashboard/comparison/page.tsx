...
import { useDynamicSalary } from "@/hooks/useDynamicSalary";
...
export default function ComparisonPage() {
  ...
  const dynamicSalary1 = useDynamicSalary(profile1);
  const dynamicSalary2 = useDynamicSalary(profile2);

  const salary1 = dynamicSalary1 ?? profile1.salary;
  const salary2 = dynamicSalary2 ?? profile2.salary;
  ...
  const salaryDifference = salary2 - salary1;

  const percentDifference = (
    (salaryDifference / profile1.salary) *
    100
  ).toFixed(1);
            ...
            >
              ...
              <CardContent>
                <div>
                  ...
                  >
                    {percentDifference}%{" "}
                    {salaryDifference >= 0 ? "higher" : "lower"}
                  </p>
                </div>
              </CardContent>
            </Card>
                  ...
                  <tbody>
                    <tr className="border-b border-border/50 hover:bg-muted/30">
                      ...
                      <td className="text-right py-3 px-4">
                        {profile1.experience_years} years
                      </td>
                      <td className="text-right py-3 px-4">
                        {profile2.experience_years} years
                      </td>
                    </tr>
                    <tr className="border-b border-border/50 hover:bg-muted/30">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-between">
            <Slider
              ...
              onValueChange={(value) =>
                onUpdate(profileNum, "experience_years", value[0])
              }
              min={0}
              max={50}
              step={1}
        ...
        <div className="space-y-2">
          ...
          <Select
            ...
            onValueChange={(value) => onUpdate(profileNum, "location", value)}
          >
        ...
        <div className="space-y-2">
          <Label
            htmlFor={`company-size-${profileNum}`}
            className="text-base font-semibold"
          >
            Company Size
          </Label>
          <Select
            ...
            onValueChange={(value) =>
              onUpdate(profileNum, "company_size", value)
            }
          >
        ...
        <div className="space-y-2">
          <Label
            htmlFor={`job-category-${profileNum}`}
            className="text-base font-semibold"
          >
            Job Category
          </Label>
          <Select
            ...
            onValueChange={(value) =>
              onUpdate(profileNum, "job_category", value)
            }
          >
          ...
          <div className="grid grid-cols-2 gap-3">
            {SKILLS.map((skill) => (
              <div key={skill} className="flex items-center space-x-2">
                ...
                />
                <Label
                  htmlFor={`skill-${profileNum}-${skill}`}
